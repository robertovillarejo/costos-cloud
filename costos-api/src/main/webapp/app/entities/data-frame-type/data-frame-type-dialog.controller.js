(function() {
    ...
    DataFrameTypeDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', '$q', 'entity', 'DataFrameType', 'RulePersistable'];

    function DataFrameTypeDialogController ($timeout, $scope, $stateParams, $uibModalInstance, $q, entity, DataFrameType, RulePersistable) {
        var vm = this;

        vm.dataFrameType = entity;
        vm.clear = clear;
        vm.save = save;
        vm.rulePersistable = RulePersistable.query();
        $timeout(function (){
