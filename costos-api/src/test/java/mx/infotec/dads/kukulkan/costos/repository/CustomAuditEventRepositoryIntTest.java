...
import mx.infotec.dads.kukulkan.costos.config.audit.AuditEventConverter;
import mx.infotec.dads.kukulkan.costos.domain.PersistentAuditEvent;
...
import static mx.infotec.dads.kukulkan.costos.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
